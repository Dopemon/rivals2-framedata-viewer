...
$(window).load($(".fd-modal").toArray().forEach((modal, i) => {
    ...
    let video1 = $(`<video class="noHitboxes top" preload="none" playsinline webkit-playsinline muted loop></video>`);
    let video2 = $(`<video class="yesHitboxes bottom" preload="none" playsinline webkit-playsinline muted loop></video>`);
