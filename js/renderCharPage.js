...
const allCharacterData = {
    ...
    Clairen: {
        ...
        moves: {
            ...
            Special: [
                { fullName: "Forward Special", shortName: "Fspecial", startFrame: 6 },
                { fullName: "Down Special", shortName: "Dspecial", startFrame: 6 },
                { fullName: "Down Special Active", shortName: "DspecialActivated", startFrame: 6 },
                { fullName: "Up Special", shortName: "Uspecial", startFrame: 6 },
                { fullName: "Neutral Special 1", shortName: "Nspecial-1", startFrame: 6 },
                { fullName: "Neutral Special 2", shortName: "Nspecial-2", startFrame: 6 },
                { fullName: "Neutral Special 3", shortName: "Nspecial-3", startFrame: 6 },
                { fullName: "Neutral Special Up 1", shortName: "NspecialUp-1", startFrame: 6 },
                { fullName: "Neutral Special Up 2", shortName: "NspecialUp-2", startFrame: 6 },
                { fullName: "Neutral Special Up 3", shortName: "NspecialUp-3", startFrame: 6 },
                { fullName: "Neutral Special Down 1", shortName: "NspecialDown-1", startFrame: 6 },
                { fullName: "Neutral Special Down 2", shortName: "NspecialDown-2", startFrame: 6 },
                { fullName: "Neutral Special Down 3", shortName: "NspecialDown-3", startFrame: 6 },
            ],
            Grab: [
                { fullName: "Back Throw", shortName: "Bthrow", startFrame: 6 },
                { fullName: "Forward Throw", shortName: "Fthrow", startFrame: 6 },
                { fullName: "Up Throw", shortName: "Uthrow", startFrame: 6 },
                { fullName: "Grab", shortName: "Grab", startFrame: 6 },
                { fullName: "Dash Grab", shortName: "DashGrab", startFrame: 9 },
                { fullName: "Pivot Grab", shortName: "PivotGrab", startFrame: 9 },
